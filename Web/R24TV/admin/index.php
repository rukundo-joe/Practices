...
$sql =mysqli_query($con,"SELECT * FROM Admin WHERE (Username='$uname' || Email='$uname')");
...
<html lang="en">
    <head>
        ...
        <meta name="description" content="R24TV CMS">
        <meta name="author" content="Joe Rukundo">

        <link href="assets/images/r24tv.ico" rel="icon">


        <!-- App title -->
        <title>Rwanda 24 TV | Admin Panel</title>
