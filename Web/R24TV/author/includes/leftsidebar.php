...
<li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Authors </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-post.php">Add Author</a></li>
                                    <li><a href="manage-posts.php">Manage Authors</a></li>
                                </ul>
                            </li>
...
<li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Advertisements </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                    <li><a href="add-imageAd.php">Add Image Ad</a></li>
                                    <li><a href="add-textAd.php">Add Text Ad</a></li>
   ...
   <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect dropdown-toggle info-number"><i class="mdi mdi-format-list-bulleted"></i> <span> Comments </span>&nbsp; <span class="badge bg-green">2</span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
                                  <li><a href="unapprove-comment.php">Waiting for Approval </a></li>
                                    <li><a href="manage-comments.php">Approved Comments</a></li>
                                </ul>
                            </li>   
<!-- <?#php echo $messageRow = mysqli_num_rows($messageobject->getAllMessage());  ?> to replace 2 as the actual number of comments from DB -->
                        </ul>
                    </div>
                    <!-- Sidebar -->
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> rukundojoe62@gmail.com</p>
                    </div>
